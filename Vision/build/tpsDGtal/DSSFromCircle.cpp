...
int main(int argc, char** argv)
{
    ...
    board << CustomStyle(border1.className(), new CustomColors(black, black)) << border1;
    board.saveSVG("disck_border_only.svg");


    vector<ArithmeticalDSSComputer< Iterator, Integer, 8>> TheDSS
