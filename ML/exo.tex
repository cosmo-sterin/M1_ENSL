...
Soit $f: E \subset [0,1]^d \to [0,1]$ une fonction inconnue avec E un ensemble fini.
...
Cependant comme on ne connaît pas $f$ sur $E$ en entier, on doit se contenter d'approcher $J$ par $\hat J$ \textbf{l'erreur empirique} sur $D$ :
